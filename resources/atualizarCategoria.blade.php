...
<body>
  <div class="grid-container">
    ...
    <div class="middle">
      <div class="categoriaAtualizar">
        <form name="atualizaCategoria" id="atualizaCategoria" action="atualizarCategoriaPHP.php" method="POST" enctype="application/x-www-form-urlencoded">
